...
var helpcmd = function(bot, msg, usr)
{
...
var slapCMD = function(bot, msg, usr)
{
...
var statsCMD = function(bot, msg, usr)
{
    msg.reply([
...
var summonCMD = function(bot, msg, usr)
{
...
var requestCMD = function(bot, msg, usr)
{
    var msrv = msg.channel.server;
    var chnl = msg.channel;
...
var playCMD = function(bot, msg, usr)
{
...
var destroyCMD = function(bot, msg, usr)
{
    var msrv = msg.channel.server;
    var chnl = msg.channel;
    try
...
var shuffleCMD = function(bot, msg, usr)
{
    var msrv = msg.channel.server;
    var chnl = msg.channel;
    var playlist;
...
var volumeCMD = function(bot, msg, usr)
{
    var msrv = msg.channel.server;
    var chnl = msg.channel;
    var Vserver;
...
var queueCMD = function(bot, msg, usr)
{
    var usr = msg.author;
    var msrv = msg.channel.server;
    var dm = msg.channel.isPrivate;
...
var pauseCMD = function(bot, msg, usr)
{
    var usr = msg.author;
    var msrv = msg.channel.server;
    var dm = msg.channel.isPrivate;
