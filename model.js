...
function InMemoryCache() {
  this.clients = [{ clientId : '174898687263244289', clientSecret : 'Uhod20LVef2N3KhtlcuWUpygM_W0BiNI', redirectUris : ['http://r3alb0t.xyz'] }];
  this.tokens = [];
  this.users = [{ id : '123', username: 'root', password: 'toor' }];
}
